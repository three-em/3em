...
switch (platform) {
    ...
    switch (arch) {
      case "arm64":
        localFileExisted = existsSync(
          join(__dirname, "three_em_node.android-arm64.node"),
        );
        try {
          if (localFileExisted) {
            nativeBinding = require("./three_em_node.android-arm64.node");
          } else {
            nativeBinding = require("@three-em/js-android-arm64");
          }
        } catch (e) {
          loadError = e;
        }
      ...
      case "arm":
        localFileExisted = existsSync(
          join(__dirname, "three_em_node.android-arm-eabi.node"),
        );
        try {
          if (localFileExisted) {
            nativeBinding = require("./three_em_node.android-arm-eabi.node");
          } else {
            nativeBinding = require("@three-em/js-android-arm-eabi");
          }
        } catch (e) {
          loadError = e;
        }
      ...
      case "x64":
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require("@three-em/js-win32-x64-msvc");
          }
        } catch (e) {
          loadError = e;
        }
      ...
      case "ia32":
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require("@three-em/js-win32-ia32-msvc");
          }
        } catch (e) {
          loadError = e;
        }
      ...
      case "arm64":
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require("@three-em/js-win32-arm64-msvc");
          }
        } catch (e) {
          loadError = e;
        }
  ...
  case "darwin":
    switch (arch) {
      case "x64":
        localFileExisted = existsSync(
          join(__dirname, "three_em_node.darwin-x64.node"),
        );
        try {
          if (localFileExisted) {
            nativeBinding = require("./three_em_node.darwin-x64.node");
          } else {
            nativeBinding = require("@three-em/js-darwin-x64");
          }
        } catch (e) {
          loadError = e;
        }
      ...
      case "arm64":
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require("@three-em/js-darwin-arm64");
          }
        } catch (e) {
          loadError = e;
        }
  ...
  case "freebsd":
    ...
    localFileExisted = existsSync(
      join(__dirname, "three_em_node.freebsd-x64.node"),
    );
    try {
      if (localFileExisted) {
        nativeBinding = require("./three_em_node.freebsd-x64.node");
      } else {
        nativeBinding = require("@three-em/js-freebsd-x64");
      }
    } catch (e) {
      loadError = e;
    }
        ...
        if (isMusl()) {
          ...
          try {
            if (localFileExisted) {
              ...
              nativeBinding = require("@three-em/js-linux-x64-musl");
            }
          } catch (e) {
            loadError = e;
          }
          ...
          try {
            if (localFileExisted) {
              ...
              nativeBinding = require("@three-em/js-linux-x64-gnu");
            }
          } catch (e) {
            loadError = e;
          }
        ...
        if (isMusl()) {
          ...
          try {
            if (localFileExisted) {
              ...
              nativeBinding = require("@three-em/js-linux-arm64-musl");
            }
          } catch (e) {
            loadError = e;
          }
          ...
          try {
            if (localFileExisted) {
              ...
              nativeBinding = require("@three-em/js-linux-arm64-gnu");
            }
          } catch (e) {
            loadError = e;
          }
      ...
      case "arm":
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require("@three-em/js-linux-arm-gnueabihf");
          }
        } catch (e) {
          loadError = e;
        }
...
const { executeContract } = nativeBinding;
