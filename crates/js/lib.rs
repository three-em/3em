...
mod test {
  ...
  async fn test_putKv() {
    ...
    let mut rt = Runtime::new(
      ...
      try {
          EXM.print("Data");
          SmartWeave.kv.put("hello", "world");
          return { state: EXM.testPutKv() };
        } catch(e) {
  ...
  async fn test_getKv() {
    ...
    let mut rt = Runtime::new(
      ...
      try {
          EXM.print("Data");
          SmartWeave.kv.put("blue", "butterflies");
          const val = SmartWeave.kv.get("blue");
          return { state: val };
        } catch(e) {
          return { state: e.toString() }
        }
  ...
  async fn test_delKv() {
    ...
    let mut rt = Runtime::new(
      r#"
        ...
        try {
            EXM.print("Data");
            SmartWeave.kv.put("hello", "apples");
            SmartWeave.kv.put("blue", "butterflies");
            SmartWeave.kv.del("blue");
            return { state: EXM.testDelKv() };
          } catch(e) {
            return { state: e.toString() }
          }
        }
