...
labels = {
    "bench": {"name": "3em JS", "color": "black", },
    "bench_evm": {"name": "3em EVM", "color": "green", },
    "bench_wasm": {"name": "3em WASM", "color": "red", },
    "bench_fh": {"name": "3em JS (fh)", "color": "blue", },
    "index.js": {"name": "Smartweave JS", "color": "orange", },
}
...
for result in results:
    ax.plot(np.array([round(t * 1000) for t in result["times"]]),
            color=labels[result["command"].split("/")[-1]]["color"],
            label=labels[result["command"].split("/")[-1]]["name"])
