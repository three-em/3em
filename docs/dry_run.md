...
Please refer to [our dry run example](https://github.com/three-em/3em/tree/main/docs/dry_run) to see the usage of the configuration file and the source code.
